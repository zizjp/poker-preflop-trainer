...
export default function Card({ rank, suit, color }: CardProps) {
  return (
    <motion.div
      className="bg-white rounded-xl shadow-2xl p-6 w-32 h-48 flex flex-col items-center justify-between border-2 border-gray-200"
    ...
    >
      ...
      <div className={`text-left w-full ${color}`}>
        ...
        <div className="text-4xl leading-none">{suit}</div>
      </div>
